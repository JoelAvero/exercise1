...
const FormRegister = () => {
  ...
  const handleSubmit = (event: any) => {
    ...
    const isInvalid = [false, null].some((e) =>
      Object.values(isValidField).includes(e)
    );
    ...
    <form onSubmit={handleSubmit}>
      <div className="input-container">
        <input
          ...
          className={`register-input ${
            invalidFlag &&
            (isValidField.name === false || isValidField.name === null)
              ? "error"
              : ""
          }`}
          name="name"
      ...
      <div className="input-container">
        <input
          ...
          className={`register-input ${
            invalidFlag &&
            (isValidField.lastName === false || isValidField.lastName === null)
              ? "error"
              : ""
          }`}
          name="lastName"
      ...
      <div className="input-container">
        <input
          ...
          className={`register-input ${
            invalidFlag &&
            (isValidField.password === false || isValidField.password === null)
              ? "error"
              : ""
          }`}
          name="password"
